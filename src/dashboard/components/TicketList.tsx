    ...
    if (tickets.length === 0) {
        return (
            <div className="text-center py-20 border-2 border-dashed border-slate-800 rounded-xl">
                ...
                <h3 className="text-lg font-medium text-slate-300">No hay tickets aún</h3>
                <p className="text-slate-500 mt-1">Crea tu primer ticket usando el formulario de arriba</p>
            </div>
        );
    }
